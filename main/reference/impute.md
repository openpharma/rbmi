...
[`draws()`](https://openpharma.github.io/rbmi/reference/draws.md). One
imputed dataset is created per each "sample" created by
...
by [`draws()`](https://openpharma.github.io/rbmi/reference/draws.md), to
first calculate the marginal (multivariate normal) distribution of a
...
to [`draws()`](https://openpharma.github.io/rbmi/reference/draws.md), in
particular:
...
- Bootstrapped Maximum Likelihood MI (BMLMI): it performs `D` random
  ...
  [`draws()`](https://openpharma.github.io/rbmi/reference/draws.md). A
  total number of `B*D` imputed datasets is provided, where `B` is the
...
[`draws()`](https://openpharma.github.io/rbmi/reference/draws.md). This
avoids having to re-run the
[`draws()`](https://openpharma.github.io/rbmi/reference/draws.md)
...
an example, if a subject had their ICE on "Visit 2" but had
