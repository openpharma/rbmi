...
#' approximation used when pooling with Rubin's rules. `"modern"` (default)
#' uses the Barnard-Rubin (1999) small-sample adjustment, while `"original"`
...
#'  rule is used to pool degrees of freedom; set `rubin_method = "original"` to
...
#'
#' Donald B. Rubin. Multiple Imputation for Nonresponse in Surveys. John Wiley
#' & Sons, New York, 1987. \[Section 3.3\]
#'
...
#' @title Original Rubin degrees of freedom approximation
#'
...
#' @param v_com Positive number representing the degrees of freedom in the complete-data analysis.
#' @param method Degrees-of-freedom approximation to use: `"modern"` applies
#' the Barnard-Rubin (1999) small-sample adjustment and `"original"` applies
