...
#' @param data_treatment_ice A `data.frame` that specifies the information
#'   related to intercurrent events for treatment discontinuation. See details.
...
#'
#' TODO Document `data_treatment_ice` argument
#'
...
draws.approxbayes <- function(
    ...
    assert_that(
        is.null(data_treatment_ice),
        msg = "Treatment ICEs are not supported for approximate Bayesian MI"
    )
...
draws.condmean <- function(
    ...
    assert_that(
        is.null(data_treatment_ice),
        msg = "Treatment ICEs are not supported for conditional mean MI"
    )
    longdata <- longDataConstructor$new(data, vars)
    longdata$set_strategies(data_ice)
...
draws.bmlmi <- function(
    ...
    assert_that(
        is.null(data_treatment_ice),
        msg = "Treatment ICEs are not supported for BMLMI"
    )
    longdata <- longDataConstructor$new(data, vars)
    longdata$set_strategies(data_ice)
