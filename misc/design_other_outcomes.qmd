...
We see above that also bootstrap-based multiple imputation has been proposed for survival outcomes and could therefore be supported in `rbmi`. We will need to look at the details and see how it best fits in the framework.
