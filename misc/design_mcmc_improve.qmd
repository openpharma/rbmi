...
Currently the `rstan` sampling details are controlled by a hard coded list in [`fit_mcmc`](https://github.com/openpharma/rbmi/blob/main/R/mcmc.R#L94). A few of the parameters are exposed in `method_bayes()` to the user.
